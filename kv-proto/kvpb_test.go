...
func BenchmarkKeyProtoUnmarshal(b *testing.B) {
	...
	for i := 0; i < 10000; i++ {
		data, err := github_com_golang_protobuf_proto.Marshal(NewPopulatedKey(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = data
...
func BenchmarkValueProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		data, err := github_com_golang_protobuf_proto.Marshal(NewPopulatedValue(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = data
...
func BenchmarkKVPairProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*KVPair, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedKVPair(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		data, err := github_com_golang_protobuf_proto.Marshal(pops[i%10000])
...
func BenchmarkKVPairProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		data, err := github_com_golang_protobuf_proto.Marshal(NewPopulatedKVPair(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = data
...
func TestKeyVerboseEqual(t *testing.T) {
...
func TestKVPairVerboseEqual(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedKVPair(popr, false)
	data, err := github_com_golang_protobuf_proto.Marshal(p)
	if err != nil {
...
func BenchmarkKVPairSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*KVPair, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedKVPair(popr, false)
	}
	b.ResetTimer()
...
func TestKVPairStringer(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedKVPair(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
